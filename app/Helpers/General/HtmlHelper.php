...
class HtmlHelper
{
    ...
    protected function dashboardSate($status, $state, $ppdb_id)
    {
        $backgroud_state = '';
        $is_opacity = true;
        ...
        switch ($status) {
            case 'NEW':
                $backgroud_state = 'background: linear-gradient(112.14deg, #3AB4F2 0%, #0078aa 100%);';
                $is_opacity = false;
                break;
            ...
            case 'COMPLETED':
                $backgroud_state = 'background: linear-gradient(112.14deg, #00C897 0%, #019267 100%);';
                $is_opacity = false;
                break;

            default:
                $backgroud_state = 'background: linear-gradient(112.14deg, #F0E161 0%, #C0B236 100%);';
                $is_opacity = false;
                break;
        }
        ...
        return [
            'state'             => $state,
            'backgroud_state'   => $backgroud_state,
