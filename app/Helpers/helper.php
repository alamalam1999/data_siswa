...
if (! function_exists('siteAccess')) {
    ...
    {
        $data = [];
        $site_access = session('site_access');

        if (! empty($site_access)) {
            $data = json_decode($site_access);
        }
...
if (! function_exists('schoolAccess')) {
    /**
     * @return bool
     */
    ...
    {
        $data = [];
        $school_access = session('school_access');

        if (! empty($school_access)) {
            $data = json_decode($school_access);
        }
