...
class PPDBTableAktifController extends Controller
{
    /**
    ...
    public function __invoke_aktif(Request $request)
    {
        ...
        AND
        ( ppdb_system.stage NOT IN ("SD","TK") OR ppdb_system.school_site NOT IN ("PML"))  
    ...
    public function __invoke_aktif_alazhar(Request $request)
    {
        $ppdb = PPDB::where([
            ['ppdb_id', '>=', 0],
            ['dapodik_id', '>=', 0]
