...
//
        ...
        $permissions = [
            ['name' => 'ppdb-jgk-sma',  'display' => 'PPDB JAGAKARSA - SMA'],
            ['name' => 'ppdb-jgk-smp',  'display' => 'PPDB JAGAKARSA - SMP'],
            ['name' => 'ppdb-jgk-sd',   'display' => 'PPDB JAGAKARSA - SD'],
            ['name' => 'ppdb-jgk-tk',   'display' => 'PPDB JAGAKARSA - TK'],
            ['name' => 'ppdb-cnr-sma',  'display' => 'PPDB CINERE - SMA'],
            ['name' => 'ppdb-cnr-smp',  'display' => 'PPDB CINERE - SMP'],
            ['name' => 'ppdb-cnr-sd',   'display' => 'PPDB CINERE - SD'],
            ['name' => 'ppdb-pml-kb',   'display' => 'PPDB PAMULANG - TK'],


            ['name' => 'interview-jgk-sma',  'display' => 'INTERVIEW JAGAKARSA - SMA'],
            ['name' => 'interview-jgk-smp',  'display' => 'INTERVIEW JAGAKARSA - SMP'],
            ['name' => 'interview-jgk-sd',   'display' => 'INTERVIEW JAGAKARSA - SD'],
            ['name' => 'interview-jgk-tk',   'display' => 'INTERVIEW JAGAKARSA - TK'],
            ['name' => 'interview-cnr-sma',  'display' => 'INTERVIEW CINERE - SMA'],
            ['name' => 'interview-cnr-smp',  'display' => 'INTERVIEW CINERE - SMP'],
            ['name' => 'interview-cnr-sd',   'display' => 'INTERVIEW CINERE - SD'],
            ['name' => 'interview-pml-tk',   'display' => 'INTERVIEW PAMULANG - TK'],


            ['name' => 'finance-jgk-sma',  'display' => 'FINANCE JAGAKARSA - SMA'],
            ['name' => 'finance-jgk-smp',  'display' => 'FINANCE JAGAKARSA - SMP'],
            ['name' => 'finance-jgk-sd',   'display' => 'FINANCE JAGAKARSA - SD'],
            ['name' => 'finance-jgk-tk',   'display' => 'FINANCE JAGAKARSA - TK'],
            ['name' => 'finance-cnr-sma',  'display' => 'FINANCE CINERE - SMA'],
            ['name' => 'finance-cnr-smp',  'display' => 'FINANCE CINERE - SMP'],
            ['name' => 'finance-cnr-sd',   'display' => 'FINANCE CINERE - SD'],
            ['name' => 'finance-pml-tk',   'display' => 'FINANCE PAMULANG - TK'],
        ...
        foreach ($permissions as $permission => $item) {
            $viewBackend = new Permission();
            $viewBackend->name = $item['name'];
            $viewBackend->display_name = $item['display'];
            $viewBackend->sort = $sort++;
            $viewBackend->created_by = 1;
            $viewBackend->updated_by = null;
            $viewBackend->created_at = Carbon::now();
            $viewBackend->updated_at = Carbon::now();
