    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if(response.payment_detail.length == 3) {
                ...
                $('#payment-image_confirmation_pengajuan').attr('src', hostBaseUrl + response.payment_detail[2].image_confirmation);
                alert(response.payment_detail[2].image_confirmation);
                $('#payment-image_confirmation_pengajuan').parent().attr('href', hostBaseUrl + response.payment_detail[2].image_confirmation);   
            }
