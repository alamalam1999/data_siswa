                                    ...
                                    <div class="card-body">
                                        <div class="mb-10 row">
                                            <div class="col-lg-6">
                                                ...
                                                <input name="kesiapan_value" type="number" min="0" max="5" class="check-result-value form-control form-control-solid w-100px" placeholder="CPM" value="{{ $ppdb_interview->kesiapan_value > 0 ? $ppdb_interview->kesiapan_value : ''  }}" {{ $is_interviewer_edit ? '' : 'readonly' }} />
                                            </div>
                                        ...
                                        <div class="mb-10 row">
                                            <div class="col-lg-6">
                                                ...
                                                <input class="form-control interview-file-upload" type="file" name="kesiapan_file_upload" id="kesiapan_file_upload" data-target="kesiapan_file" {{ $is_interviewer_edit ? '' : 'readonly' }}>
                                                ...
                                                <div class="d-none interview_file_result">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <button id="myButtonDelete1" class="btn btn-danger btn-remove-file" type="button">Delete</button>
                                                    </div>
                                        ...
                                        <div class="mb-5 row">
                                            <div class="col-lg-6">
                                                ...
                                                @for ($i = 3; $i < count($result_interview); $i++) <div class="form-check form-check-custom form-check-solid mb-5">
                                                    <input class="check-result form-check-input" type="radio" name="kesiapan_result" value="{{ $i + 1 }}" id="kesiapan_result_{{ $i }}" {{ $ppdb_interview->kesiapan_result == ($i+1) ? 'checked':'' }} />
                                                    <label class="form-check-label" for="kesiapan_result_{{ $i }}">
                                                        {{ $result_interview[$i] }}
                                                    </label>
                                            </div>
                                            @endfor
                                            <textarea name="kesiapan_result_note" rows="5" class="form-control form-control-solid" {{ ($ppdb_interview->psikotest_result_note != '' ? '':'readonly') }}>{{ $ppdb_interview->psikotest_result_note }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-10 row">
                                        <div class="col-lg-6">
                                            <label for="psikotest_value" class="form-label">Hasil Psikotest
                                                (IQ)</label>
                                            <input name="psikotest_value" type="number" class="check-result-value form-control form-control-solid w-100px" placeholder="IQ" value="{{ $ppdb_interview->psikotest_value > 0 ? $ppdb_interview->psikotest_value : ''  }}" {{ $is_interviewer_edit ? '' : 'readonly' }} />
                                        </div>
                                    ...
                                    <div class="mb-10 row">
                                        <div class="col-lg-6">
                                            <label for="psikotest_file_upload" class="form-label">Upload Hasil
                                                Psikotest</label>
                                            <input class="form-control interview-file-upload" type="file" name="psikotest_file_upload" id="psikotest_file_upload" data-target="psikotest_file">
                                            <input type="hidden" name="psikotest_file" id="psikotest_file" value="{{ $ppdb_interview->psikotest_file }}" />

                                            <div class="d-none interview_file_result">
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control bg-light" value="nama file tersebut.jpg" readonly>

                                                    <button class="btn btn-danger btn-remove-file" type="button">Delete</button>
                                                </div>
                                                <a href="#" target="_blank" class="ms-3">Download File</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-5 row">
                                        <div class="col-lg-6">
                                            ...
                                            @for ($i = 0; $i < count($result_interview); $i++) <div class="form-check form-check-custom form-check-solid mb-5">
                                                <input class="check-result form-check-input" type="radio" name="psikotest_result" value="{{ $i + 1 }}" id="psikotest_result_{{ $i }}" {{ $ppdb_interview->psikotest_result == ($i+1) ? 'checked':'' }} />
                                                <label class="form-check-label" for="psikotest_result_{{ $i }}">
                                                    {{ $result_interview[$i] }}
                                                </label>
                                        </div>
                                        @endfor
                                        <textarea name="psikotest_result_note" rows="5" class="form-control form-control-solid" {{ ($ppdb_interview->psikotest_result_note != '' ? '':'readonly') }}>{{ $ppdb_interview->psikotest_result_note }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer d-flex justify-content-end py-6">
                        ...
                        <div class="card-body">
                            <div class="mb-10 row">
                                <div class="col-lg-4">
                                    ...
                                    <input name="academic_value" id="academic_value" type="number" class="check-result-value form-control form-control-solid w-150px" placeholder="Hasil" value="{{ $ppdb_interview->academic_value > 0 ? $ppdb_interview->academic_value : ''  }}" />
                                </div>
                            ...
                            <div class="mb-10 row">
                                <div class="col-lg-6">
                                    <label for="academic_file_upload" class="form-label">Upload Hasil
                                        Literasi & Numerasi</label>
                                    <input class="form-control interview-file-upload" type="file" name="academic_file_upload" id="academic_file_upload" data-target="academic_file">
                            ...
                            <div class="mb-5 row">
                                <div class="col-lg-6">
                                    ...
                                    @for ($i = 0; $i < count($result_interview); $i++) <div class="form-check form-check-custom form-check-solid mb-5">
                                        <input class="check-result form-check-input" type="radio" name="academic_result" value="{{ $i + 1 }}" id="academic_result_{{ $i }}" {{ $ppdb_interview->academic_result == ($i+1) ? 'checked':'' }} />
                                        <label class="form-check-label" for="academic_result_{{ $i }}">
                                            {{ $result_interview[$i] }}
                                        </label>
                                </div>
                                @endfor
                                <textarea name="academic_result_note" rows="5" class="form-control form-control-solid" {{ ($ppdb_interview->academic_result_note != '' ? '':'readonly') }}>{{ $ppdb_interview->academic_result_note }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-end py-6">
                ...
                <div class="card rounded-0">
                    <div class="card-body">
                        <div class="mb-10">
                            ...
                            <textarea rows="8" name="interview_parent_summary" id="interview_parent_summary" class="form-control" placeholder="Tuliskan Ringkasannya">{{ $ppdb_interview->interview_parent_summary }}</textarea>
                        </div>
                        ...
                        <div class="mb-10 row">
                            ...
                            <div class="col-lg-6">
                                <label for="interview_parent_file_upload" class="form-label">Upload
                                    Hasil
                                    Akademik</label>
                                <input id="inputUpload2" class="form-control interview-file-upload" type="file" name="interview_parent_file_upload" id="interview_parent_file_upload" data-target="interview_parent_file">
                                ...
                                <div class="d-none interview_file_result">
                                    <div class="input-group mb-3">
                                        ...
                                        <button id="myButtonDelete2" class="btn btn-danger btn-remove-file" type="button">Delete</button>
                                    </div>
                                    <a href="#" target="_blank" class="ms-3">Download File</a>
                                </div>
                            </div>
                        ...
                        <div class="mb-5 row">
                            ...
                            <div class="col-lg-6">
                                ...
                                @for ($i = 0; $i < count($result_interview_parent_sd); $i++) <div class="form-check form-check-custom form-check-solid mb-5">
                                    <input class="check-result form-check-input" type="radio" name="interview_parent_result" value="{{ $i + 1 }}" id="interview_parent_result_{{ $i }}" {{ $ppdb_interview->interview_parent_result == ($i+1) ? 'checked':'' }} />
                                    <label class="form-check-label" for="interview_parent_result_{{ $i }}">
                                        {{ $result_interview_parent_sd[$i] }}
                                    </label>
                            </div>
                            @endfor
                            <textarea name="interview_parent_result_note" rows="5" class="form-control form-control-solid" {{ ($ppdb_interview->interview_parent_result_note != '' ? '':'readonly') }}>{{ $ppdb_interview->interview_parent_result_note }}</textarea>
            ...
            <div class="card rounded-0">
                <div class="card-body">
                    <div class="mb-10">
                        ...
                        <textarea rows="8" class="form-control" name="interview_student_summary" id="interview_student_summary" placeholder="Tuliskan Ringkasannya">{{ $ppdb_interview->interview_student_summary }}</textarea>
                    </div>
                    ...
                    <div class="mb-10 row">
                        ...
                        <div class="col-lg-6">
                            <label for="interview_student_file_upload" class="form-label">Upload
                                Hasil
                                Akademik</label>
                            <input class="form-control interview-file-upload" type="file" name="interview_student_file_upload" id="interview_student_file_upload" data-target="interview_student_file">
                    ...
                    <div class="mb-5 row">
                        ...
                        <div class="col-lg-6">
                            ...
                            @for ($i = 0; $i < count($result_interview); $i++) <div class="form-check form-check-custom form-check-solid mb-5">
                                <input class="check-result form-check-input" type="radio" name="interview_student_result" value="{{ $i + 1 }}" id="interview_student_result_{{ $i }}" {{ $ppdb_interview->interview_student_result == ($i+1) ? 'checked':'' }} />
                                <label class="form-check-label" for="interview_student_result_{{ $i }}">
                                    {{ $result_interview[$i] }}
                                </label>
                        </div>
                        @endfor
                        <textarea name="interview_student_result_note" rows="5" class="form-control form-control-solid" {{ ($ppdb_interview->interview_student_result_note != '' ? '':'readonly') }}>{{ $ppdb_interview->interview_student_result_note }}</textarea>
                    </div>
                </div>
            </div>
            <div class="card-footer d-flex justify-content-end py-6">
            ...
            <div class="card-body">
                <div class="mb-10 row">
                    <div class="col-lg-5">
                        ...
                        <input name="observasi_value" id="observasi_value" type="number" class="check-result-value form-control form-control-solid w-150px" placeholder="Hasil Akademik" value="{{ $ppdb_interview->observasi_value }}" />
                    </div>
                ...
                <div class="mb-10">
                    ...
                    <textarea rows="5" class="form-control" name="observasi_summary" id="observasi_summary" placeholder="Tuliskan Ringkasannya">{{ $ppdb_interview->observasi_summary }}</textarea>
                </div>
                ...
                <div class="mb-10 row">
                    <div class="col-lg-6">
                        <label for="observasi_file_upload" class="form-label">Upload Hasil
                            Akademik</label>
                        <input id="inputUpload3" class="form-control interview-file-upload" type="file" name="observasi_file_upload" id="observasi_file_upload" data-target="observasi_file">
                        ...
                        <div class="d-none interview_file_result">
                            <div class="input-group mb-3">
                                ...
                                <button id="myButtonDelete3" class="btn btn-danger btn-remove-file" type="button">Delete</button>
                            </div>
                            <a href="#" target="_blank" class="ms-3">Download File</a>
                        </div>
                    </div>
                ...
                <div class="mb-5 row">
                    <div class="col-lg-6">
                        ...
                        @for ($i = 0; $i < count($result_interview_parent_sd); $i++) <div class="form-check form-check-custom form-check-solid mb-5">
                            <input class="check-result form-check-input" type="radio" name="observasi_result" value="{{ $i + 1 }}" id="observasi_result_{{ $i }}" {{ $ppdb_interview->observasi_result == ($i+1) ? 'checked':'' }} />
                            <label class="form-check-label" for="observasi_result_{{ $i }}">
                                {{ $result_interview_parent_sd[$i] }}
                            </label>
                    </div>
                    @endfor
                    <textarea name="observasi_result_note" rows="5" class="form-control form-control-solid" {{ ($ppdb_interview->observasi_result_note != '' ? '':'readonly') }}>{{ $ppdb_interview->observasi_result_note }}</textarea>
                </div>
            </div>
        </div>
        <div class="card-footer d-flex justify-content-end py-6">
    ...
    <div class="card rounded-0">
        <div class="card-body">
                ...
                <table class="table table-rounded table-striped border gy-4 gs-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="observasi_value_result" id="observasi_value_result" type="number" class="form-control form-control-solid w-150px form-control-transparent d-none" value="{{ $ppdb_interview->observasi_value }}" readonly />
                            </td>
            ...
            <div class="border-top my-5 border border-secondary p-5 border-2 rounded bg-light">
                ...
                <div class="mb-5 pb-5 px-5 row border-bottom">
                    <div class="col-lg-7">
                        <label for="school_recomendation_result_file_upload" class="form-label">Upload
                            Surat
                            Keterangan</label>
                        <input class="form-control interview-file-upload" type="file" name="school_recomendation_file_upload" id="school_recomendation_file_upload" data-target="school_recomendation_file">
                ...
                <div class="mb-10 px-5">
                    ...
                    <div class="btn-group w-100" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">
                        <!--begin::Radio-->
                        <label class="btn bg-white btn-outline-secondary text-gray-800 text-hover-white text-active-white btn-outline btn-active-success min-w-300px {{ $ppdb_interview->interview_result == 1 ? 'active':'' }}" data-kt-button="true">
                            <!--begin::Input-->
                            <input class="btn-check" type="radio" name="school_recomendation_result" value="1" {{ $ppdb_interview->interview_result == 1 ? 'checked':'' }} />
                            <!--end::Input-->
                            Direkomendasikan
                        </label>
                        <!--end::Radio-->
                        ...
                        <!--begin::Radio-->
                        <label class="btn bg-white btn-outline-secondary text-gray-800 text-hover-white text-active-white btn-outline btn-active-danger min-w-300px {{ $ppdb_interview->interview_result == 2 ? 'active':'' }}" data-kt-button="true">
                            <!--begin::Input-->
                            <input class="btn-check" type="radio" name="school_recomendation_result" value="2" {{ $ppdb_interview->interview_result == 2 ? 'checked':'' }} />
                            <!--end::Input-->
                        ...
                        <!--begin::Radio-->
                        <label class="btn bg-white btn-outline-secondary text-gray-800 text-hover-white text-active-white btn-outline btn-active-warning min-w-300px fs-6 {{ $ppdb_interview->interview_result == 3 ? 'active':'' }}" data-kt-button="true">
                            <!--begin::Input-->
                            <input class="btn-check" type="radio" name="school_recomendation_result" value="3" {{ $ppdb_interview->interview_result == 3 ? 'checked':'' }} />
                            <!--end::Input-->
                            Di pertimbangkan
                        </label>
                        <!--end::Radio-->
                ...
                <div class="mb-5 ps-5">
                    ...
                    <textarea name="school_recomendation_note" rows="5" class="form-control">{{ $ppdb_interview->interview_result_note }}</textarea>
                </div>

                @if(!($ppdb_interview->school_recomendation_result > 0))
                <div class="d-none bg-warning mb-5 ps-5 d-flex flex-stack w-lg-100 p-5 rounded px-10">

                    <!--begin::Label-->
                    <div class="me-5">
                        <label class="fs-4 fw-bolder text-white form-label">Konfirmasi Persetujuan</label>
                        <div class="fs-5 fw-semibold text-white">Saya sudah memastikan bahwa penilaian dari pihak sekolah adalah sebagai tertera diatas</div>
                    </div>
                    <!--end::Label-->

                    <!--begin::Switch-->
                    <label class="form-check form-switch form-check-custom form-check-solid">
                        <input id="form-confirmationxx" class="form-check-input" type="checkbox" value="1">
                    </label>
                    <!--end::Switch-->
                </div>
                @endif
            ...
            <div class="border-top my-5 border border-success p-5 border-2 rounded bg-light-success">
                <div class="fs-5 fw-bolder form-label px-5">Berikut ini adalah penilaian dan rekomendasi dari RND YPAP :</div>
                ...
                <div class="mb-10 px-5">
                    ...
                    <div class="btn-group w-100" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">
                        ...
                        <label class="btn bg-white btn-outline-secondary text-muted text-hover-white text-active-white btn-outline btn-active-success min-w-300px {{ $ppdb_interview->interview_result == 1 ? 'active':'' }}" data-kt-button="true">
                            <!--begin::Input-->
                            <input class="btn-check" type="radio" name="interview_result" value="1" {{ $ppdb_interview->ypap_result == 1 ? 'checked':'' }} />
                            <!--end::Input-->
                            Lulus
                        </label>
                        <!--end::Radio-->
                        ...
                        <label class="btn bg-white btn-outline-secondary text-muted text-hover-white text-active-white btn-outline btn-active-danger min-w-300px {{ $ppdb_interview->interview_result == 2 ? 'active':'' }}" data-kt-button="true">
                            <!--begin::Input-->
                            <input class="btn-check" type="radio" name="interview_result" value="2" {{ $ppdb_interview->ypap_result == 2 ? 'checked':'' }} />
                            <!--end::Input-->
                            Tidak Lulus
                        </label>
                        <!--end::Radio-->
                ...
                <div class="mb-5 ps-5">
                    <label class="form-label">Note</label>
                    <textarea name="ypap_result_note" rows="5" class="form-control">{{ $ppdb_interview->ypap_result_note }}</textarea>
                </div>
            </div>
           

            <div class="d-none border-top my-5 border border-success p-5 border-2 rounded bg-light-success">
                <div class="d-flex flex-stack mb-5">
                    <div class="fs-5 fw-bolder form-label px-5">Berdasarkan hasil rekapitulasi
                        penilaian dan keputusan pimpinan sekolah, maka dengan ini siswa tersebut
                        dinyatakan :</div>
                </div>

                <div class="mb-5 pb-5 px-5 row border-bottom">
                    <div class="col-lg-7">
                        <label for="interview_result_file_upload" class="form-label">Upload
                            Surat
                            Kelulusan</label>
                        <input class="form-control interview-file-upload" type="file" name="interview_result_file_upload" id="interview_result_file_upload" data-target="interview_result_file">
                ...
                <div class="mb-10 px-5">
                    ...
                    <div class="btn-group w-100" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">
                        ...
                        <label class="btn bg-white btn-outline-secondary text-gray-800 text-hover-white text-active-white btn-outline btn-active-success min-w-300px {{ $ppdb_interview->interview_result == 1 ? 'active':'' }}" data-kt-button="true">
                            <!--begin::Input-->
                            <input class="btn-check" type="radio" name="interview_result" value="1" {{ $ppdb_interview->interview_result == 1 ? 'checked':'' }} />
                            <!--end::Input-->
                            Lulus
                        </label>
                        <!--end::Radio-->
                        ...
                        <label class="btn bg-white btn-outline-secondary text-gray-800 text-hover-white text-active-white btn-outline btn-active-danger min-w-300px {{ $ppdb_interview->interview_result == 2 ? 'active':'' }}" data-kt-button="true">
                            <!--begin::Input-->
                            <input class="btn-check" type="radio" name="interview_result" value="2" {{ $ppdb_interview->interview_result == 2 ? 'checked':'' }} />
                            <!--end::Input-->
                            Tidak Lulus
                        </label>
                        <!--end::Radio-->
                        ...
                        <label class="btn bg-white btn-outline-secondary text-gray-800 text-hover-white text-active-white btn-outline btn-active-warning min-w-300px fs-6 {{ $ppdb_interview->interview_result == 3 ? 'active':'' }}" data-kt-button="true">
                            <!--begin::Input-->
                            <input class="btn-check" type="radio" name="interview_result" value="3" {{ $ppdb_interview->interview_result == 3 ? 'checked':'' }} />
                            <!--end::Input-->
                            Dipertimbangkan dengan catatan
                        </label>
                        <!--end::Radio-->
                ...
                <div class="mb-5 ps-5">
                    <label class="form-label">Note</label>
                    <textarea name="interview_result_note" rows="5" class="form-control">{{ $ppdb_interview->interview_result_note }}</textarea>
                </div>

                <div class="bg-danger mb-5 ps-5 d-flex flex-stack w-lg-100 p-5 rounded px-10">
                    ...
                    <!--begin::Switch-->
                    <label class="form-check form-switch form-check-custom form-check-solid">
                        <input id="form-confirmationx" class="form-check-input" type="checkbox" value="1">
                    </label>
                    <!--end::Switch-->
                </div>
            </div>
            ...
            @if($is_interviewer && ($ppdb_interview->interview_result == 1 || $ppdb_interview->interview_result == 2))
