    ...
    <div class="card">
        <div class="card-header pt-7">
            ...
            <h3 class="card-title align-items-start flex-column">
                ...
                <span class="text-gray-400 mt-1 fw-semibold fs-6">List Data Siswa Aktif Sekolah Avicenna</span>
            </h3>
            <!--end::Title-->
            <!--begin::Toolbar-->
                ...
                <div class="col">
                    <div class="table-responsive">
                        <table id="ppdb-table"
                            ...
                            data-ajax_url="{{ route('admin.ppdb.aktif') }}">
                            <thead>
                                <!--begin::Table row-->
...
@section('pagescript')
    ...
    <script src="{{ asset('assets/js/pages/admin/aktif.js') }}"></script>
