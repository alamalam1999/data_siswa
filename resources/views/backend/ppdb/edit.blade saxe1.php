                            ...
                            <div class="tab-pane fade" id="kt_tab_pane_3" role="tabpanel">
                                <div class="card border shadow-sm">
                                  ...
                                  <div class="card-header bg-light mb-6">
                                      <!--begin::Title-->
                                      <h3 class="card-title align-items-start flex-column">
                                          <span class="card-label fw-bolder">FORMULIR PESERTA DIDIDK (DIISI PADA SAAT PENDAFTARAAN SISWA)</span>
                                      </h3>
                                      <!--end::Title-->
                                  </div>
                                  ...
                                  <div class="card-header bg-light mb-6">
                                      <!--begin::Title-->
                                      <h3 class="card-title align-items-start flex-column">
                                          <span class="card-label fw-bolder">PERNYATAAN ORANG TUA (DIISI PADA SAAT PENDAFTARAAN SISWA)</span>
                                      </h3>
                                      <!--end::Title-->
                                  </div>
                                  ...
                                  <div class="card-header bg-light mb-6">
                                      <!--begin::Title-->
                                      <h3 class="card-title align-items-start flex-column">
                                          <span class="card-label fw-bolder">PERSETUJUAN TATA TERTIB (DIISI PADA SAAT PENDAFTARAAN SISWA)</span>
                                      </h3>
                                      <!--end::Title-->
                                  </div>
                                  ...
                                  <div class="btndown1 card-header bg-light mb-6">
                                        <!--begin::Title-->
                                        <h3 class="card-title align-items-start flex-column">
                                            <span class="card-label fw-bolder">INFORMASI KEADAAN JASMANI (DIISI PADA SAAT PENDAFTARAAN SISWA)</span>
                                        </h3>
                                        <!--end::Title-->
                                  </div>
                                  <div class="informasi">
                                  ...
                                  <div class="card-header bg-light mb-6">
                                    <!--begin::Title-->
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder">INFORMASI ANGKET (DIISI PADA SAAT PENDAFTARAAN SISWA)</span>
                                    </h3>
                                    <!--end::Title-->
                                   </div>
