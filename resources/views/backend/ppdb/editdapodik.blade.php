              ...
              <?php
                $document_no = "";
                    if($ppdb != null && $ppdb != "" && !empty($ppdb)) {
                        $document_no = $ppdb->document_no;
                       }
                ?>
                <h3 class="card-title text-gray-800 fw-bold">No. Regristrasi (Kode Siswa) : <?php echo e($document_no); ?></h3>
                                        ...
                                        <!--end::Card title-->
                                          ...
                                          <div class="image-input image-input-outline image-input-placeholder mb-3 image-input-changed" data-kt-image-input="true">
                                              ...
                                              <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" aria-label="Change avatar" data-bs-original-title="Change avatar" data-kt-initialized="1">
                                                  ...
                                                  <!--begin::Inputs-->
                                                  <input type="file" name="fhoto_siswa" required>
                        ...
                        <div class="card bg-white border">
                          <form action="{{ route('admin.ppdb.updatekontakdapodik') }}" method="POST">
                            ...
                            <div class="card-body text-center">
                              <input type="hidden" name="dapodik_id" value="{{ $ppdb->id }}">
                       ...
                       <form action="{{ route('admin.ppdb.addclasses') }}" method="POST" >
                        ...
                        <div class="row fv-row mb-5">
                          ...
                          <div>
                            ...
                            <option value="{{ !empty($unitvalue) ? $unitvalue : '' }}">{{ !empty($unitvalue) ? $unitvalue : 'Pilih Wilayah' }}</option>
        ...
        <div class="row fv-row mb-7 fv-plugins-icon-container">
          ...
          <div class="col-xl-6">
              ...
              <?php
                ...
                ?>
              <input class="form-control form-control-transparent border-bottom" type="text" value="<?php echo e($document_no); ?>" readonly autocomplete="off">
              <div class="fv-plugins-message-container invalid-feedback"></div>
          </div>
          <!--end::Col-->
