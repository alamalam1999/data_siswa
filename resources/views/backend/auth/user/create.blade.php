                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-stack fs-4 py-3">
                            <div class="fw-bold rotate collapsible">Account Information
                        ...
                        <div id="kt_user_view_details" class="collapse show mt-5">
                            ...
                            <div class="pb-5 fs-6">
                                ...
                                <div class="form-floating mb-5">
                                    ...
                                    {{ Form::label('last_name', __('validation.attributes.backend.access.users.last_name'), ['class' => 'form-control-label']) }}
                                </div>
                                <!--form-group-->
                                ...
                                <div class="form-floating mb-5">
                                    ...
                                    {{ Form::label('email', __('validation.attributes.backend.access.users.email'), ['class' => 'form-control-label']) }}
                                </div>
                                <!--form-group-->
                                ...
                                <div class="form-floating mb-5">
                                    ...
                                    {{ Form::label('password', __('validation.attributes.backend.access.users.password'), ['class' => 'form-control-label']) }}
                                </div>
                                <!--form-group-->
                                ...
                                <div class="form-check form-check-custom form-check-solid mb-5">
                                    ...
                                    {{ Form::label('status', trans('validation.attributes.backend.access.users.active'), ['class' => 'form-check-label']) }}
                                </div>
        
                                <div class="form-check form-check-custom form-check-solid mb-5">
                                    {{ Form::checkbox('confirmed', '1', true, [ 'class' => 'form-check-input']) }}
                                    {{ Form::label('confirmed', trans('validation.attributes.backend.access.users.confirmed'), ['class' => 'form-check-label']) }}
                                </div>
        
                                @if (!config('access.users.requires_approval'))
                                    <div class="form-check form-check-custom form-check-solid mb-5">
                                        {{ Form::checkbox('confirmation_email', '1', false, [ 'class' => 'form-check-input']) }}
                                        {{ Form::label('confirmed', trans('validation.attributes.backend.access.users.send_confirmation_email'), ['class' => 'form-check-label']) }}
                                    ...
                                    <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Badge=-->
                                                <!--begin::Status=-->
                                                <td>POST /v1/invoices/in_5927_4380/payment</td>
                                                <!--end::Status=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-end min-w-200px">20 Jun 2022, 5:20 pm</td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            <!--begin::Table row-->
                                            <tr>
                                                ...
                                                <!--end::Badge=-->
                                                <!--begin::Status=-->
                                                <td>POST /v1/invoices/in_3728_6712/payment</td>
                                                <!--end::Status=-->
                                                <!--begin::Timestamp=-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Badge=-->
                                                <!--begin::Status=-->
                                                <td>POST /v1/invoices/in_7333_2179/payment</td>
                                                <!--end::Status=-->
                                                <!--begin::Timestamp=-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Badge=-->
                                                <!--begin::Status=-->
                                                <td>POST /v1/invoice/in_7654_2750/invalid</td>
                                                <!--end::Status=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-end min-w-200px">20 Jun 2022, 11:30 am</td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            <!--begin::Table row-->
                                            <tr>
                                                ...
                                                <!--end::Badge=-->
                                                <!--begin::Status=-->
                                                <td>POST /v1/customer/c_62c3e70a203ea/not_found</td>
                                                <!--end::Status=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-end min-w-200px">05 May 2022, 6:05 pm</td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                        </tbody>
                                ...
                                <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Event=-->
                                            <!--begin::Timestamp=-->
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2022, 5:20 pm</td>
                                            <!--end::Timestamp=-->
                                        </tr>
                                        <!--end::Table row-->
                                        <!--begin::Table row-->
                                        <tr>
                                            ...
                                            <!--end::Event=-->
                                            <!--begin::Timestamp=-->
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2022, 6:43 am</td>
                                            <!--end::Timestamp=-->
                                        </tr>
                                        <!--end::Table row-->
                                        <!--begin::Table row-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 search-permission">
                            <div id="available-permissions">
                                <div>
                                    <input type="text" class="form-control search-button"
                                        placeholder="Search..." />
                                </div>
