...
> </style>
> <![endif]-->
        <title>PPDB Sekolah Avicenna</title>
        <style type="text/css">
            div,
            p,
            a,
                    ...
                    <tr>
                        <td>
                            <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style="background-color:#ffffff; border-radius:5px 5px 0 0;">
                                <tr>
                                    <td>
                                        <table width="265" align="left" border="0" cellspacing="0" cellpadding="0" class="inner" style="text-align:center;">
                                            <tr>
                                            ...
                                            <tr>
                                                <td width="28">&nbsp;</td>
                                                <td align="center" valign="middle"><a href="#"><img src="https://sekolah-avicenna.sch.id/images/logo-avicenna-ppdb.png" alt="Wohoo" width="226" height="50"></a></td>
                                            </tr>
                                            <tr>
                                            </tr>
                                        </table>
                    ...
                    <tr>
                        <td>
                            <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style="text-align:center; border-bottom:1px solid #e5e5e5;">
                                ...
                                <tr>
                                    <td style="font: 700 30px 'Montserrat', Helvetica, Arial, sans-serif; color: #f27b69; text-transform: uppercase; font-size: 29px;">Selamat</td>
                                </tr>
                                <tr>
                                    <td height="28">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align:center;">
                                            <tr>
                                                <td width="28">&nbsp;</td>
                                                <td align="center" style="font: 22px Arial, Helvetica, sans-serif; color:#404040;">Akun Anda telah berhasil dibuat</td>
                                                <td width="28">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td width="28"></td>
                                            ...
                                            <tr>
                                                <td width="28">&nbsp;</td>
                                                <td style="font: 16px Arial, Helvetica, sans-serif; color:#404040; text-align: left; ">
                                                    Terima kasih telah melakukan Pendaftaran Peserta Didik Baru : <br /><br /><br />
                                                </td>
                                                <td width="28">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td width="28">&nbsp;</td>
                                                <td style="font: 16px Arial, Helvetica, sans-serif; color:#404040; padding-left: 100px;">
                                                    <table align="left" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align:center;">
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style="width: 100px; text-align: left;">Email</td>
                                                            <td height="28">:</td>
                                                            <td style="text-align: left; padding-left: 5px;"> {{ $email }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 100px; text-align: left;">Phone</td>
                                                            <td height="28">:</td>
                                            ...
                                            <tr>
                                                <td width="28">&nbsp;</td>
                                                <td style="font: 16px Arial, Helvetica, sans-serif; color:#404040; text-align: left; "><br /><br />
                                                    Setelah anda melakukan verifikasi pendaftaran, silakan ada melakukan login. Lanjutkan untuk melengkapi biodata untuk Penerimaan Peserta Didik Baru.
                                                </td>
                                                <td width="28">&nbsp;</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td width="28"></td>
                                                <td align="center">
                                                    <a href="{{ $link }}" style="font:700 16px 'Montserrat', Helvetica, Arial, sans-serif; color:#ffffff; text-decoration:none; text-transform:uppercase; display:block; overflow:hidden; outline:none;">
                                                        <table align="center" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align:center;">
                                                            <tr>
                                                                <td align="center" bgcolor="#af5372" style="border-radius:28px; padding:0 28px;" height="61">
                                                                    <span style="font:700 16px 'Montserrat', Helvetica, Arial, sans-serif; color:#ffffff; text-decoration:none; text-transform:uppercase; display:block; overflow:hidden; outline:none;">
                                                                        LOGIN & LENGKAP PROFILE
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                        </table>
                                            ...
                                            <tr>
                                                <td width="28"></td>
                                                <td align="center">
                                                    <table width="290" border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align:center;">
                                                    </table>
                                        ...
                                        <table width="230" border="0" cellspacing="0" cellpadding="0" align="left" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align:center;" class="inner">
                                            <tr>
                                                ...
                                                <td>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                                        <tr>
                                                            <td align="center" style="font:11px Helvetica,  Arial, sans-serif; color:#ffffff;">&copy; 2022, All rights reserved
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td height="18">&nbsp;</td>
