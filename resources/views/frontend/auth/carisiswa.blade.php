...
<div class="card-toolbar" style="padding-right: 1180px">
  <!--begin::Daterangepicker(defined in src/js/layout/app.js)-->
  <a href="<?php echo asset ('/'); ?>" class="btn btn-sm btn-light d-flex align-items-center px-4" data-kt-initialized="1">
