                                    ...
                                    <div class="card-body" style="padding: 0.5rem 2rem; background-position: 100% 50%; background-image:url('{{ asset('assets/media/stock/900x600/42.png') }}');">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-7 ps-xl-13">
                                                ...
                                                <!--end::Title-->
                                                <!--begin::Text-->
                                                <span class="fw-semibold text-white fs-6 mb-4 d-block opacity-75"><span style="color: #736251" class="fw-bold">Anda dapat menggunggah kembali dokumen-dokumen pendukung yang terlupa</span> saat awal pendaftaran.</span>
                                                <!--end::Text-->
                                                <!--begin::Items-->
                                            ...
                                            <div class="text-center">
                                                @if ($ppdb->INTERVIEW_STATE == 'COMPLETED') 
                                                    <span class="svg-icon svg-icon-3x svg-icon-success">
                                                        ...
                                                        <div class="btn btn-sm btn-white fw-bold mt-5 disabled">
                                                            <div class="text-gray-700 fw-semibold fs-6">Selamat Anda Lulus Ke Tahap Berikutnya</div>
                                                        </div>
                                                    </span>
