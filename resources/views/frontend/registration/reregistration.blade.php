              ...
              <div class="test2">
               {{ csrf_field() }}
                <div class="form-group mb-4">
                  ...
                  <input name="nameparent" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Jawaban Anda" value="{{ $logged_in_user->full_name }}">
                </div>
               ...
               <div class="test4">
                    ...
                    @if($ppdb->stage == 'TK' || $ppdb->stage == 'KB')
                      ...
                      <div class="fv-row mb-10 has-feedback">
                        ...
                        <input type="file" name="photo" class="required5 form-control" id="exampleInputFile">
...
$(document).ready(function() {
      ...
      $('.btncekempat').click(function(){
        if($('.required1').val() == ''){
            alert('Nama calon Murid belum di isi');
        }
      });
