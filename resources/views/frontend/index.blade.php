        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav navbar-right" data-in="#" data-out="#">
                    ...
                    <li><a href="#event"><i class="fa fa-calendar"></i> Informasi & Jadwal </a></li>
                    <li>
                        <a href="#contact"><i class="fa fa-book"></i> contact</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </div>
                        ...
                        <div class="col-md-6">
                            <div class="content-box">
                                ...
                                <form action="#">
                                    ...
                                    @else
                                    <button class="btn btn-dark effect btn-sm" disabled="" style="background: #999 !important;">
                                        Saat ini belum ada jadwal pendaftaran</button>
                                    @endisset
                                </form>
