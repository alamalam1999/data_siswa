...
<html lang="en">
	...
	<head>
        ...
        <link href="{{ asset('assets/css/style.custom.css') }}?v=1.0.0" rel="stylesheet" type="text/css" />
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body data-kt-name="metronic" id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" data-bs-offset="200" class="bg-white position-relative app-blank">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			...
			<div class="mb-0" id="home">
				<!--begin::Wrapper-->
				<div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom" style="background-image: url(assets/media/stock/900x600/42.png)">
					<!--begin::Header-->
					<div class="landing-header landing-dark-bg" data-kt-sticky="true" data-kt-sticky-name="landing-header" data-kt-sticky-offset="{default: '200px', lg: '300px'}" style="height: 70px;">
						<!--begin::Container-->
						<div class="container">
							<!--begin::Wrapper-->
