    ...
    <div class="row">
      <div class="col-md-3">
        <div class="col lg-30">
            ...
            <div class="card mt-15 mb-27 bg-white border">  
                <div class="card-body">
                    {{-- BATAS --}}
                    <h4 class="card-title">
            ...
            <div class="card mb-20 bg-white border">
                <div class="card-body">
                    <h4 class="card-title">
                        <div style="font-size: 13px;"><strong>INFORMASI BIAYA FORMULIR</strong></div>
                        <br />
                ...
                @else
                    <div class="card ">
                        <div class="card-header card-header-stretch">
                            <h1 class="card-title">KONFIRMASI BIAYA PENDAFTARAN</h1>
                        </div>
                        <div class="card-body">
                            <!--begin::Form-->
                            <form role="form" method="post" action="{{ route('frontend.user.ppdb.payment.formulir_post', $ppdb) }}" enctype="multipart/form-data">
                                ...
                                <div style="margin-top:-30px; margin-bottom:50px; font-size:2px;"> 
