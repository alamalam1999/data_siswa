...
@section('content')
    <form id="form-payment-administration" role="form" method="post"
                        ...
                        <div class="mt-n1">
                            ...
                            <div class="m-0">
                                ...
                                <div class="row g-5 mb-12">
                                    ...
                                    <div class="col-sm-6">
                                        <!--end::Label-->
                                        <div class="fw-semibold fs-7 text-gray-600 mb-1">Pembayaran Untuk :</div>
                                        <!--end::Label-->
                                        <!--end::Text-->
                                        <div class="fw-bold fs-6 text-gray-800">{{ $ppdb->fullname }}.</div>
                                        <!--end::Text-->
                                        <!--end::Description-->
                                        <div class="fw-semibold fs-7 text-gray-600">{{ $ppdb->address }}
                                        </div>
                                        <!--end::Description-->

                                        <div class="mt-5 fw-semibold fs-7 text-gray-600 mb-1">Status Pekerja Medco :</div>
                                        <!--end::Label-->
                                        <!--end::Text-->
                                        <?php
                                        ...
                                        ?>
                                        <div class="fw-bold fs-6 text-gray-800">{{ $ppdb->ppdb_discount ? $ppdb->ppdb_discount."." : '-' }}</div>

                                        <div class="row">
                                            <div class="col-sm">
                                                <div class="mt-5 fw-semibold fs-7 text-gray-600 mb-1">Status Siswa :</div>
                                                <div class="fw-bold fs-6 text-gray-800">{{ $ppdb->status_siswa ? $ppdb->status_siswa."." : '-' }}</div>
                                            </div>
                                            <div class="col-sm">
                                                <div class="mt-5 fw-semibold fs-7 text-gray-600 mb-1">Kelas :</div>
                                                <div class="fw-bold fs-6 text-gray-800">{{ $ppdb->classes ? $ppdb->classes."." : '-' }}</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <!--end::Label-->
                                        <div class="fw-semibold fs-7 text-gray-600 mb-1">Tanggal Konfirmasi:</div>
                                        <!--end::Label-->
                                        <!--end::Col-->
                                        <div class="fw-bold fs-6 text-gray-800">{{ now()->toDateString() }}</div>
                                        <div class="fw-semibold fs-7 text-gray-600 mb-6"></div>
                                        <!--end::Col-->
                                        ...
                                        <div class="row">
                                            <div class="col-sm">
                                                ...
                                                ?>
                                                <div class="mt-5 fw-semibold fs-7 text-gray-600 mt-1 mb-1">Diskon (Medco Group):</div>
                                                <div class="fw-bold fs-6 text-gray-800">{{ $discount }}</div>
                                            </div>
                                            <div class="col-sm">
                                                <div class="mt-5 fw-semibold fs-7 text-gray-600 mt-1 mb-1">Diskon UP Bayar Lunas:</div>
                                                <div class="fw-bold fs-6 text-gray-800">Rp.500.000</div>   
                                            </div>
                                        ...
                                        <div class="row">
                                                <div class="col-sm">
                                                    <div class="mt-5 fw-semibold fs-7 text-gray-600 mb-1">Pendaftaran siswa Gelombang ke:</div>
                                                    <div class="fw-bold fs-6 text-gray-800">{{ $registration_wave ? $registration_wave."." : '-' }}</div>
                                                </div>
                                        </div>
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="table-responsive border-bottom mb-9">
                                        ...
                                        <table id="mytable" class="table mb-3" >
                                            <thead>
                                                <tr class="border-bottom fs-6 fw-bold text-muted">
                                                    ...
                                                    <th class="min-w-150px text-end pb-2">Amount</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr class="fw-bold text-gray-700 fs-5 text-end">
                                                    ...
                                                    <td class="pt-6">@currency($up_normal_lunas[0]->price_value)</td>
                                                    <td rowspan="2" class="pt-6 text-dark fw-bolder"
                                                        style="vertical-align: middle;" id="fee_up_amount_display">0</td>
                                                </tr>
                                                ...
                                                <tr class="fw-bold text-gray-700 fs-5 text-end">
                                                    ...
                                                    <td class="pt-6 px-2">@currency($up_normal_cicilan[0]->price_value)</td>                                          
                                                </tr>
                                                <tr class="fw-bold text-gray-700 fs-5 text-end">
                                                    ...
                                                    <div class="border-top mb-6 mt-6 border border-primary p-5 border-2 rounded">
                                                       <div class="d-flex w-lg-100">
                                                           <!--begin::Label-->
                                                               <label class="form-check form-switch form-check-custom form-check-solid w-70px">
                                                                   <input id="is-employee-cicilan" class="form-check-input" type="checkbox" value="true" autocomplete="off">
                                                               </label>
                                                           <div class="me-5">
                                                               <label class="fs-6 fw-semibold form-label">Pembayaran UP yang melalui surat pengajuan</label>
                                                           </div>
                                                           <!--end::Label-->
                                                       </div>
           
                                                       <div id="box-employee-cicilan" class="d-none mt-10">
                                                           <div class="fv-row mb-7 fv-plugins-icon-container">
                                                               <label class="form-label fw-bold text-dark fs-6">Nominal pembayaran UP yang disetujui</label>
                                                               <input name="cicilan_employee" class="form-control form-control-lg form-control-solid" type="number" placeholder="Masukkan Nominal" autocomplete="off">
                                                               <div class="fv-plugins-message-container invalid-feedback"></div>
                                                           </div>
                                                           <div class="fv-row mb-7 fv-plugins-icon-container">
                                                               <label class="form-label fw-bold text-dark fs-6">Surat persetujuan pembayaran UP yang disetujui
                                                                <div class="px-2 fs-9">
                                                                    <span style="color:red">* Surat persetujuan besaran nominal pembayaran UP harus ditandatangani oleh sekolah Avicenna atau YPAP</span> 
                                                                </div>
                                                               </label>
                                                              
                                                               <input type="file" class="form-control form-control-lg form-control-solid" name="cicilan_employee_file_input" data-image="cicilan_employee_file" autocomplete="off" accept="application/pdf, image/*">
                                                               <div class="fv-plugins-message-container invalid-feedback"></div>
                                                           </div>
                                        ...
                                        <table id="mytable2" class="table  mb-3"">
                                            <thead>
                                                <tr class="border-bottom fs-6 fw-bold text-muted">
                                            ...
                                            <tbody>
                                                <tr class="fw-bold text-gray-700 fs-5 text-end">
                                                    ...
                                                    <td class="pt-6">@currency($spp_normal[0]->price_value)</td>
                                                    <td rowspan="2" class="pt-6 text-dark fw-bolder"
                                                        style="vertical-align: middle;" id="fee_spp_amount_display">0</td>
                                                </tr>
                                                <tr class="fw-bold text-gray-700 fs-5 text-end">
                                                    ...
                                                    <td class="pt-6 px-2">@currency($spp_normal_12bulan[0]->price_value)</td>
                                                </tr>
                                    ...
                                    <!--end::Table-->
                                        <div class="border-top mb-6 border border-primary p-5 border-2 rounded">
                                            <div class="d-flex w-lg-100">
                                                <!--begin::Label-->
                                                    <label class="form-check form-switch form-check-custom form-check-solid w-70px">
                                                        <input id="is-employee-medco" class="form-check-input" type="checkbox" value="true" autocomplete="off">
                                                    </label>
                                                <div class="me-5">
                                            ...
                                            <div id="box-employee-medco" class="d-none mt-10">
                                                ...
                                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                                    ...
                                                    <input type="file" class="form-control form-control-lg form-control-solid" name="medco_employee_file_input" data-image="medco_employee_file" autocomplete="off" accept="application/pdf, image/*">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                    ...
                                    <div class="d-flex justify-content-end">
                                     ...
                                     <!--begin::Alert-->
                                        <div class="alert alert-info d-flex align-items-center p-5 mt-4 mb-10">
                                            <!--begin::Icon-->
        ...
        <input type="hidden" name="cicilan_employee_type" value="" />
        <input type="hidden" name="cicilan_employee" value="0" />
